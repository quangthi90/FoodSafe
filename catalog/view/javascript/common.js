var AppCommon = (function($, undefined){
	...
	function doSlideShow () {
		//Category show
		var categorySlideShowEle = $('#category_slideshow');
		if(categorySlideShowEle.length > 0 && categorySlideShowEle.find(".item").length > 0){
			categorySlideShowEle.owlCarousel({
	          items: categorySlideShowEle.find(".item").length,
	          autoPlay: 5000,
	          singleItem: true,
	          navigation: true,
